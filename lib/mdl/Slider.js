...
class Slider extends Component {
  ...
  static propTypes = {
    ...
    lowerTrackStyle: ViewPropTypes.style,
    ...
    return (
      ...
      >
        ...
        <Thumb
          ...
          enabledColor={this.props.thumbColor ? this.props.thumbColor : lowerTrackColor}
          disabledColor={this.props.thumbColor ? this.props.thumbColor : upperTrackColor}
